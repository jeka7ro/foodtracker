...
async function run() {
    ...
    const fetchDay = async (day) => {
        const reqBody = {
            ...
            deliveryDateFrom: `2026-05-${day} 00:00:00.000`,
            deliveryDateTo: `2026-05-${day} 23:59:59.000`,
            statuses: ["Closed"]
        };
        ...
        console.log(`Orders count ${day}.05:`, data.ordersByOrganizations?.[0]?.orders?.length || 0);
    }
