...
async function run() {
    ...
    const reqBody = {
        ...
        deliveryDateFrom: "2026-05-10 00:00:00.000",
        deliveryDateTo: "2026-05-10 23:59:59.000",
        statuses: ["Closed"]
    };
    ...
    console.log("Orders count 10.05:", data.ordersByOrganizations?.[0]?.orders?.length || 0);
}
run();
